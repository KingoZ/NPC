...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder {
	...
	public EntityNPCPlayer(Location spawn, NPC npc, NPCProfile profile) {
		super(((CraftServer) Bukkit.getServer()).getServer(), ((CraftWorld) spawn.getWorld()).getHandle(),
				profile.getHandle(), new PlayerInteractManager(((CraftWorld) spawn.getWorld()).getHandle()));
		this.npc = npc;
